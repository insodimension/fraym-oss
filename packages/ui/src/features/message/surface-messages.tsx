...
export function surfaceText(input: SurfaceRenderInput): string { if (input.channel === "message") return input.text ?? (typeof input.payload === "string" ? input.payload : ""); return "message" in input.request ? input.request.message : ""; }
