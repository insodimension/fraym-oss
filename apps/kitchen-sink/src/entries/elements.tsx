...
import { recipeRunEntries } from "./recipe-run-entry";
import { silkWaveEntries } from "./silk-wave-entry";
import { studioRendererEntries } from "./studio-renderers-entry";
		...
		>
			<div className="flex max-w-sm flex-col gap-5">
				<Select
					...
					options={[
						{ value: "assistant", label: "assistant Sonnet" },
...
const selectDocs: EntryDocs = {
	...
	examples: [
		{
			label: "From data",
			code: `<Select\n  value={model}\n  onChange={e => setModel(e.target.value)}\n  options={[{ value: "assistant", label: "assistant" }, { value: "gpt", label: "GPT-5" }]}\n/>`,
		},
		{
			label: "From children",
...
export const elementsEntries: readonly ShowcaseEntry[] = [
	...
	...withGroup("Studio", [...recipeRunEntries, ...studioRendererEntries]),
];
